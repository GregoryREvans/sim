...
import evans
from sim.Materials.score_structure.Segment_I.articulation_material_pattern import (
    articulation_material_list,
)
from sim.Materials.score_structure.Segment_I.dynamic_material_pattern import (
    dynamic_material_list,
)
from sim.Materials.score_structure.Segment_I.pitch_material_pattern import (
    pitch_material_list,
)
from sim.Materials.score_structure.Segment_I.rhythm_material_pattern import (
    rhythm_material_list,
)
from sim.Materials.score_structure.Segment_I.time_signatures import bounds
from sim.Materials.timespans.Segment_I.make_timespans import (
